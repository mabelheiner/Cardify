...
const Home = () => {
  return (
    <div>
        <header style={{display: 'flex', backgroundColor: '#eef8eb', borderBottom: '1px solid #2c4f40'}}>
            ...
            <div style={{marginLeft: 'auto', paddingRight: '.5em', marginTop: 'auto', marginBottom: 'auto'}}>
              {/* <CgProfile size={5}/> */}
              <svg fill="#eef8eb" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" height="50px" width="50px">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M16 9C16 11.2091 14.2091 13 12 13C9.79086 13 8 11.2091 8 9C8 6.79086 9.79086 5 12 5C14.2091 
              ...
              <path fill-rule="evenodd" clip-rule="evenodd" d="M12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23C18.0751 23 23 18.0751 23 12C23 
